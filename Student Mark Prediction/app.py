...
app = Flask(__name__)
model = joblib.load(r"C:\Users\darsh\OneDrive\Desktop\FSDS\Resume Project\Project_12\Student Mark Prediction\Student Mark Prediction\Student_mark_predictor.pkl")
